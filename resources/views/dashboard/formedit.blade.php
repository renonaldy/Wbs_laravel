                                ...
                                <div class="row">
                                                        ...
                                                        @foreach ($item as $index => $item2)
                                                            ...
                                                            <label for="{{ 'jenis' . $item2->id }}" class="form-label">
                                                                <input type="checkbox" value="{{ $item2->id }}"
                                                                    ...
                                                                    {{ in_array($item2->id, explode(',', $laporan->jenis_pelanggaran_id)) ? 'checked' : '' }}>
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-sm-12 col-lg-12">
                                            <div class="card">
                                                <div class="card-body bg-gray-200 border-radius-lg">
                                                    <textarea name="kejadian_pertama" id="kejadian_pertama" class="form-control">{{ old('kejadian_pertama', $laporan->kejadian_pertama) }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div><br>
                                            ...
                                            <div class="card">
                                                <div class="card-body bg-gray-200 border-radius-lg">
                                                    ...
                                                    <input name="tanggal" type="date" class="form-control" id="tanggal"
                                                        value="{{ \Carbon\Carbon::parse($laporan->tanggal)->toDateString() }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="card">
                                                <div class="card-body bg-gray-200 border-radius-lg">
                                                    ...
                                                    <input name="jumlah_kerugian" type="number" id="jumlah_kerugian"
                                                        size="auto"
                                                        value="{{ old('jumlah_kerugian', $laporan->jumlah_kerugian) }}" />
                                                </div>
                                            </div>
                                        </div>
                                    </div><br>
                                            ...
                                            <div class="card">
                                                <div class="card-body bg-gray-200 border-radius-lg">
                                                    <select name="jabatan_terlapor" class="form-control"
                                                        value="{{ $laporan->jabatan_terlapor }}">
                                                        <option value="">-Pilih Disini-</option>
                                                        <option
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-sm-12 col-lg-12">
                                            <div class="card">
                                                <div class="card-body bg-gray-200 border-radius-lg">
                                                    <textarea class="form-control" id="berbicara" name="berbicara">{{ old('berbicara', $laporan->berbicara) }}
                                                    </textarea>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-sm-12 col-lg-12">
                                            <div class="card">
                                                <div class="card-body bg-gray-200 border-radius-lg">
                                                    <textarea class="form-control" id="posisi" name="posisi">{{ old('posisi', $laporan->posisi) }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div><br>
                                    <div>
                                        <button type="submit"
                                            class="btn btn-lg bg-gradient-info  btn-lg w-200 mt-4 mb-0">Update
                                            Laporan</button>
                                    </div>
                        </form>
